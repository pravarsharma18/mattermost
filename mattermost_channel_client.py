        ...
        try:
            ...
            for chat in chats:
                ...
                if len(rec_ids) == 2:
                    ...
                    if creator_id:
                        channel_values = [self.generate_id(26), int(chat['creation_time']), chat['last_modified_time'], 0, "",
                                        "D", "", rec_ids_str, "", "", chat['last_modified_time'], 0, 0, creator_id[0]['id'], json.dumps(False), 0, int(chat['last_modified_time']), chat['chat_id']]
